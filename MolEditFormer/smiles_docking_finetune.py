...
def main(args):
    ...
    print("device:", device)
    if args.dir_name == "":
        model_save_dir = osp.join(args.store_dir, f"{args.data_source}_{args.target_name}_{args.molecule_type}")
    else:
...
if __name__ == "__main__":
    ...
    # save config
    parser.add_argument("--store_dir", type=str, default="ckpt/MolEditFormer/finetune_docking")
