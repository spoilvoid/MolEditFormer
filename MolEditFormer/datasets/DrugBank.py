...
class DrugBank_retrieval_Graph(InMemoryDataset):
    def __init__(
        ...
        super(DrugBank_retrieval_Graph, self).__init__(root, transform, pre_transform, pre_filter)
    ...
    def process(self):
        ...
        for line_id, line in enumerate(f.readlines()):
            ...
            data = dataset_utils.mol_to_graph_data_obj_simple(rdkit_mol)
...
class DrugBank_ATC_Graph(InMemoryDataset):
    def __init__(
        ...
        super(DrugBank_ATC_Graph, self).__init__(root, transform, pre_transform, pre_filter)
