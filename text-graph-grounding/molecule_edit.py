...
from molecule_edit_utils import get_SMILES_list, get_description_list, load_language_molecule_and_edit_models, clip_loss_for_edit, evaluate_SMILES_list
from basic_utils import prepare_text_tokens
...
def check_edit(SMILES, text):
    ...
    # 记录输入的SMILES与输入SMILES经过MegaMolBART编码解码后得到的SMILES
